...
export default function View({ state, page: handlers }) {
...
function TopicAuthorInfo({ topic }) {
	...
	return (
		<section className="author-info">
			<Link href={`/user?name=${topic.author.loginname}`}>
	...
	return (
		<li>
			<section className="user">
				<Link href={`/user?name=${reply.author.loginname}`}>
					<img className="head" src={reply.author.avatar_url} />
				</Link>
				<div className="info">
					<span className="cl">
